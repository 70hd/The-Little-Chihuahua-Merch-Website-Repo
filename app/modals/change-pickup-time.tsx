...
const ChangePickupTime = ({ modal, setModal, setPickupDetails,checkout = false }: ChangePickupTimeProps) => {
  ...
  return (
    <div className={`${checkout ? "sm:bottom-[-338px] bottom-[-350px] sm:left-[94px]" : "top-12 left-[-16px]"} absolute   w-full  z-50 flex items-center justify-center ${checkout ? "" : "top-15"} `}>
      <div className="min-w-[285px] sm:min-w-[392px] h-fit flex flex-col gap-6 p-6 bg-white border-black/75 border-[.5px]">
        <div className="w-full flex justify-between">
          <h3 id="modal-heading">Customize Pickup Time</h3>
          <button
            aria-label="Close"
