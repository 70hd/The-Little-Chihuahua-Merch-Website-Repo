...
async function main() {
  try {
    ...
    //   data: [
    //     { productId: createdProducts[0].id, size: "Xtra Small", inventory: 1, status: "AVAILABLE" },
    //     { productId: createdProducts[0].id, size: "Small", inventory: 1, status: "AVAILABLE" },
    //     { productId: createdProducts[0].id, size: "Medium", inventory: 1, status: "AVAILABLE" },
    //     { productId: createdProducts[0].id, size: "Large", inventory: 1, status: "AVAILABLE" },
    //     { productId: createdProducts[0].id, size: "Xtra Large", inventory: 1, status: "AVAILABLE" },
    //     { productId: createdProducts[1].id, size: "Small (3-6lbs)", inventory: 1, status: "AVAILABLE" },
    //     { productId: createdProducts[1].id, size: "Medium (6-10lbs)", inventory: 1, status: "AVAILABLE" },
    //     { productId: createdProducts[1].id, size: "Large (10-14lbs)", inventory: 1, status: "AVAILABLE" },
    //     { productId: createdProducts[1].id, size: "XLarge (14-20lbs)", inventory: 1, status: "AVAILABLE" },
    //     { productId: createdProducts[1].id, size: "XXX Large (25-35lbs)", inventory: 1, status: "AVAILABLE" },
    //     { productId: createdProducts[1].id, size: "5XL (45-60Lbs)", inventory: 1, status: "AVAILABLE" },
    //     { productId: createdProducts[2].id, size: "(FIGURE OUT THE SIZE THAT IT IS)", inventory: 1, status: "AVAILABLE" },
    //     { productId: createdProducts[3].id, size: "(FIGURE OUT THE SIZE THAT IT IS)", inventory: 1, status: "AVAILABLE" },
    //     { productId: createdProducts[4].id, size: "Small", inventory: 1, status: "AVAILABLE" },
    //     { productId: createdProducts[4].id, size: "Medium", inventory: 1, status: "AVAILABLE" },
    //     { productId: createdProducts[4].id, size: "Large", inventory: 1, status: "AVAILABLE" },
    //     { productId: createdProducts[4].id, size: "Xtra Large", inventory: 1, status: "AVAILABLE" },
    //     { productId: createdProducts[5].id, size: "Small", inventory: 1, status: "AVAILABLE" },
    //     { productId: createdProducts[5].id, size: "Medium", inventory: 1, status: "AVAILABLE" },
    //     { productId: createdProducts[5].id, size: "Large", inventory: 1, status: "AVAILABLE" },
    //     { productId: createdProducts[5].id, size: "Xtra Large", inventory: 1, status: "AVAILABLE" },
    //   ],
    // });

    // const prices = await prisma.prices.createMany({
    //   data: [
    //     { productId: createdProducts[0].id, price: 20 },
    //     { productId: createdProducts[1].id, price: 25 },
    //     { productId: createdProducts[1].id, price: 35 },
    //     { productId: createdProducts[2].id, price: 25 },
    //     { productId: createdProducts[3].id, price: 20 },
    //     { productId: createdProducts[4].id, price: 55 },
    //     { productId: createdProducts[5].id, price: 55 },
    //   ],
    // });
